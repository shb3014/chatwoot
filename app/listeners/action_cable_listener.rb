class ActionCableListener < BaseListener
  ...
  def typing_event_listener_tokens(account, conversation, user)
    # Determine the current user's token based on user type
    # Captain::Assistant doesn't have pubsub_token, so we use nil for it
    ...
    current_user_token ? tokens - [current_user_token] : tokens
  end
